...
namespace DIMS_Core.Tests.Repositories
{
    public class DirectionRepositoryTests : IDisposable
    {
        ...
        public async AliasThreading.Task GetAll_OK()
        {
            // Act
        ...
        [Fact]
        public async AliasThreading.Task GetById_OK()
        {
            // Act
        ...
        [Fact]
        public async AliasThreading.Task GetById_EmptyId_Fail()
        {
            // Arrange
            const int id = 0;
        ...
        [Fact]
        public async AliasThreading.Task GetById_NotExistDirection_Fail()
        {
            // Arrange
        ...
        [Fact]
        public async AliasThreading.Task Create_OK()
        {
            // Arrange
        ...
        [Fact]
        public async AliasThreading.Task Create_EmptyEntity_Fail()
        {
            // Arrange Act, Assert
        ...
        [Fact]
        public async AliasThreading.Task Update_OK()
        {
            // Arrange
            var entity = new Direction
                         {
        ...
        [Fact]
        public async AliasThreading.Task Delete_OK()
        {
            // Act
        ...
        [Fact]
        public async AliasThreading.Task Delete_EmptyId_Fail()
        {
            // Arrange
            const int id = 0;
